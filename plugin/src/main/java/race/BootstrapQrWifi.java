...
public class BootstrapQrWifi extends Link {

    final String hostname;
    final int port;
    private Socket socket;
    private Thread monitorThread;
    final String logLabel = "race.BootstrapQrWifi";
    ...
    void sendPackage(JEncPkg pkg) {
        final String loggingPrefix = logLabel + "sendPackageBootstrapQrWifi (" + linkId + "): ";
        RaceLog.logDebug(loggingPrefix, "sendPackageBootstrapQrWifi: called", "");
