...
public class BootstrapQrWifiProfileParser extends LinkProfileParser {

    static final String logLabel = "race.BootstrapQrWifiProfileParser";
    private String hostname = "";
    private int port = -1;
    private boolean multicast = false;

    BootstrapQrWifiProfileParser(String linkProfile) {
    ...
    Link createLink(PluginCommsQrWifiJava plugin, JLinkConfig linkConfig, String channelGid) {
        ...
        RaceLog.logDebug(logLabel, "Creating Bootstrap QR Wifi Link: " + linkId, "");
        return new BootstrapQrWifi(
                plugin,
                linkId,
