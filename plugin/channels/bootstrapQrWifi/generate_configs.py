...
def main() -> None:
    """
    Purpose:
        Generate configs for twoSixDirectJava
    Args:
        N/A
    Returns:
        N/A
    ...
    # Load (or create) and validate NETWORK_MANAGER Request
...
def get_cli_arguments() -> argparse.Namespace:
    ...
    optional.add_argument(
        ...
        help=(
            "Requested links from NETWORK_MANAGER. Configs should generate only these"
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        stream=sys.stdout,
        level=LOG_LEVEL,
        format="[generate_comms_java_direct_configs] %(asctime)s.%(msecs)03d %(levelname)s %(message)s",
